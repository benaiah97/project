...
public abstract class UtilityXML {
	...
	/**
	 * Returns an eGalaxy formatted date, when given a GregorianCalendar object
	 * 
	 * @param timeStamp
   ...
   */
	...
	/**
	 * Takes in a date string and returns a Gregorian Calendar. Date is expected to be in format yyyy-MM-dd
	 * 
	 * @param dateString
	 * @return GregorianCalendar
	 */
	public static GregorianCalendar getGCalFromNexusDate(String dateString) {
	...
	/**
	 * Returns a Nexus formatted date, when given a GregorianCalendar object
	 * 
	 * @param dateStamp
	 * @return String date formatted yyyy-MM-dd
	 */
	public static String getNexusDateFromGCal(GregorianCalendar dateStamp) {

		Date now = dateStamp.getTime();
