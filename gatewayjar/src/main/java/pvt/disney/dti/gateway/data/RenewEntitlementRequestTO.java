...
<<<<<<< HEAD
  ...
  /**
   * Identifies this as an installment reservation request (one which includes installment
   * payments.  This flag is set when the installment payment amount is validated.
   * {@link ProductRules.validateInstallmentDownpayment() }
   */
  private boolean isInstallmentRenewRequest = false;
  
  /**
   * Identifies the amount of the down-payment.  This value is set when the installment
   * payment amount is verified.  It is used to populate values in the out-bound transaction
   * to eGalaxy. {@link ProductRules.validateInstallmentDownpayment() }
   */
  private BigDecimal installmentDownpayment = null;

  /**
   * The total order amount (as summarized by the business rules).
   * {@link BusinessRules.applyReservationRules() }
   */
  ...
  /**
   * @param eligibilityGroup the eligibilityGroup to set
   */
  ...
  /**
   * @param eligibilityMember the eligibilityMember to set
   */
  ...
  /**
   * @param isInstallmentRenewRequest the isInstallmentResRequest to set
   */
