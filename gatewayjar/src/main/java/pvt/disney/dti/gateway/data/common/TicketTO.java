...
=======
	...
	public TicketTO clone() throws CloneNotSupportedException {
		...
		// TODO: Remove method calls in favor of direct assignments.
...
>>>>>>> develop
	/**
	 * Used to represent the pair of repeating status items and status values for tickets.
	 * 
	 * @author lewit019
	 */
	...
	/**
	 * WDW ticket seller can assign each ticket to be associated with and entitlement account. This is an account and the number of these tickets to associate with it.
	 * 
	 * @author SHIEC014
	 * 
	 */
  ...
  public TicketTO() {
    ...
    /**
     * Overrides Object.clone() to provide a shallow copy of the 
     * TicketTO object.  
     * @return TicketTO
     */
  @SuppressWarnings("unchecked")
...
<<<<<<< HEAD
  /**
   * @param existingTktID the existingTktID to set
   */
