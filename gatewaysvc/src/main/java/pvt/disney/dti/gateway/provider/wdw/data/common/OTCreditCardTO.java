 ...
 * 
 */
public class OTCreditCardTO implements Serializable {
	...
	/**
	 * Sets the promo expiration date, but takes in a formatted string such as yy-MM-dd (09-01-31) to do it.
	 * 
	...
	public void setPromoExpDate(String promoExpDateString) throws ParseException {
		...
		this.promoExpDate = OTCommandTO.convertOmniYYDate(promoExpDateString);
	}
	...
	public Integer getCardTypeInteger() {
		...
		if (giftCardIndicator) return GIFTTCARDTYPE;
		else {
	...
	public void setGiftCardIndicator(int giftCardInt) {
		if (giftCardInt == GIFTTCARDTYPE) setGiftCardIndicator(true);
		else setGiftCardIndicator(false);
	}
