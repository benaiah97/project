...
<<<<<<< HEAD
   ...
   */
  public static QueryReservationRequestTO getTO(QueryReservationRequest queryResReq)
      throws JAXBException {
  ...
  public static QueryReservationResponse getJaxb(QueryReservationResponseTO qryResRespTO,
  ...
  private static void setJaxbTicketList(List<QueryReservationResponse.Ticket> ticketList,
    ...
    for /* each */(TicketTO aTicketTO : /* in */ticketListTO) {
      ...
      if ((aTicketTO.getTktValidityValidStart() != null)
        ...
        JAXBElement<String> tktValidityElement = new JAXBElement(qName, tktValidity.getClass(),
            tktValidity);
      ...
      if (aTicketTO.getProdCode() != null) {
        ...
        JAXBElement<String> tktProdCodeElement = new JAXBElement(qName, aTicketTO.getProdCode()
            .getClass(), aTicketTO.getProdCode());
