 ...
 * @author lewit019
 */
public class OTPaymentTO implements Serializable {
	...
	private OTCreditCardTO creditCard;

	/** The Omni Ticket Voucher object. */
	private OTVoucherTO voucher;

	/** The Omni Ticket Intallment object. (As of 2.15, JTL) */
	private OTInstallmentTO installment;
	 ...
	 */
	public OTCreditCardTO getCreditCard() {
		return creditCard;
	}
	 ...
	 */
	public void setCreditCard(OTCreditCardTO creditCard) {
	 ...
	 *            the voucher to set
	 */
	public void setVoucher(OTVoucherTO voucher) {
		this.payType = PaymentType.VOUCHER;
	 ...
	 */
	public OTInstallmentTO getInstallment() {
		return installment;
	}
	 ...
	 */
	public void setInstallment(OTInstallmentTO installment) {
