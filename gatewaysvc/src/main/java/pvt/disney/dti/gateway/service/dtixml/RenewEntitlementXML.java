...
<<<<<<< HEAD
   ...
   */
  public static RenewEntitlementRequestTO getTO(RenewEntitlementRequest renewEntReq) throws JAXBException {

    RenewEntitlementRequestTO renewEntReqTO = new RenewEntitlementRequestTO();

    // Ticket List
    List<RenewEntitlementRequest.Ticket> ticketList = renewEntReq.getTicket();
    ...
    if (renewEntReq.getEligibility() != null) {
      RenewEntitlementRequest.Eligibility elig = renewEntReq.getEligibility();
      renewEntReqTO.setEligibilityGroup(elig.getGroup());
      renewEntReqTO.setEligibilityMember(elig.getMember());
    }

    // Payment
    List<RenewEntitlementRequest.Payment> paymentList = renewEntReq.getPayment();
    ...
    if (renewEntReq.getReservation() != null) {
      RenewEntitlementRequest.Reservation renewEnt = renewEntReq.getReservation();
    ...
    if (renewEntReq.getClientData() != null) {
      RenewEntitlementRequest.ClientData clientData = renewEntReq.getClientData();
   ...
   */
  public static RenewEntitlementResponse getJaxb(RenewEntitlementResponseTO renewRespTO, DTIErrorTO errorTO)
      throws JAXBException {
    ...
    if (renewRespTO.getTicketList() != null) {
      List<RenewEntitlementResponse.Ticket> ticketList = renewResp.getTicket();
    ...
    if (renewRespTO.getProductList() != null) {
      ...
      List<RenewEntitlementResponse.Product> productList = renewResp.getProduct();
    ...
    if (renewRespTO.getPaymentList() != null) {
      List<RenewEntitlementResponse.Payment> paymentList = renewResp.getPayment();
    ...
    if ( (renewal.getContractId() != null) || 
         (renewal.getTktTransaction() != null)) {
    ...
    if (renewRespTO.getClientData() != null) {
      ...
      // Optional field
      if (renewRespTO.getClientData().getClientId() != null)
        clientData.setClientId(renewRespTO.getClientData().getClientId());
   ...
   *           for any JAXB parsing issue.
   */
  private static void setJaxbPaymentList(List<RenewEntitlementResponse.Payment> paymentList,
  ...
  private static void setJaxbTicketList(List<RenewEntitlementResponse.Ticket> ticketList, ArrayList<TicketTO> ticketListTO,
   ...
   */
  private static void setTOClientData(RenewEntitlementRequest.ClientData clientData, ClientDataTO clientDataTO) {
    ...
    if (clientData.getDemoData() != null) {
      ...
      RenewEntitlementRequest.ClientData.DemoData demoData = clientData.getDemoData();

      if (demoData.getBill() != null) {
        DemographicsTO demoTO = new DemographicsTO();
        RenewEntitlementRequest.ClientData.DemoData.Bill billData = demoData.getBill();
      ...
      if (demoData.getShip() != null) {
        ...
        DemographicsTO demoTO = new DemographicsTO();
        RenewEntitlementRequest.ClientData.DemoData.Ship shipData = demoData.getShip();
   ...
   */
  private static void setTOPaymentList(ArrayList<PaymentTO> paymentListTO, RenewEntitlementRequest.Payment aPayment) {
    ...
    if (payType.getCreditCard() != null) { // THIS IS A CREDIT CARD
      ...
      RenewEntitlementRequest.Payment.PayType.CreditCard creditCard = payType.getCreditCard();

      if (creditCard.getCCManual() != null) {

        RenewEntitlementRequest.Payment.PayType.CreditCard.CCManual ccManual = creditCard.getCCManual();
        ...
        RenewEntitlementRequest.Payment.PayType.CreditCard.CCSwipe ccSwipe = creditCard.getCCSwipe();
        ...
        RenewEntitlementRequest.Payment.PayType.CreditCard.CCWireless ccWireless = creditCard.getCCWireless();
      ...
      if (payType.getGiftCard().getGCManual() != null) {
        RenewEntitlementRequest.Payment.PayType.GiftCard.GCManual gcManual = payType.getGiftCard().getGCManual();
        ...
        RenewEntitlementRequest.Payment.PayType.GiftCard.GCSwipe gcSwipe = payType.getGiftCard().getGCSwipe();
      ...
      RenewEntitlementRequest.Payment.PayType.Installment installment = payType.getInstallment();
   ...
   */
  private static void setTOTicketList(ArrayList<TicketTO> ticketListTO, RenewEntitlementRequest.Ticket aTicket) {
    ...
    // ExistingTktID
    aTicketTO.setExistingTktID(translateExistingTktID(aTicket.getExistingTktID()));
   ...
   *          a JAXB parsed ticket.
   */
  private static TicketTO translateExistingTktID(RenewEntitlementRequest.Ticket.ExistingTktID tktId) {
      ...
      if (tktId.getExternal() != null) {
        ...
        if (tktId.getTktNID() != null) {
          ...
          if (tktId.getMag() != null) {
            RenewEntitlementRequest.Ticket.ExistingTktID.Mag tktMag = tktId.getMag();
            ...
            if (tktId.getTktDSSN() != null) {
              RenewEntitlementRequest.Ticket.ExistingTktID.TktDSSN tktDssn = tktId.getTktDSSN();
