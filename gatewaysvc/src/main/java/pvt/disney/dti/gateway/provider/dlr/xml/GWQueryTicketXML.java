...
/**
 * This class has the responsibility for marshaling and unmarshlling the DLR Query Ticket XML.
 * 
 * @author lewit019
 * 
 */
...
<<<<<<< HEAD
  ...
  public static void addQueryTicketElement(GWQueryTicketRqstTO qtReqTO, Element bodyElement) throws DTIException {
    ...
    if ((qtReqTO.isIncludeTktDemographics())
        || (qtReqTO.isIncludeRenewalAttributes())) {
  ...
  /**
   * Unmarshall the errors element into the gateway query ticket errors transfer
   * object.
   * 
   * @param errorsElement
...
=======
	...
	public static void addQueryTicketElement(GWQueryTicketRqstTO qtReqTO,
		...
		String visualID = qtReqTO.getVisualID();
		if (visualID == null) throw new DTIException(GWBodyXML.class,
		...
		if ((qtReqTO.isIncludeTktDemographics()) || (qtReqTO
