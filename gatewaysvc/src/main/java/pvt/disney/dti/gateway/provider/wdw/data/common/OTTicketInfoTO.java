...
public class OTTicketInfoTO implements Serializable {
  ...
  /** account ID of electronic entitlement */
  ...
  /**
   * Allows the caller to set the validity end date as a string, with the format
   * yy-MM-dd (such as 09-01-31).
   * 
   * @param validityEndDate
  ...
  /**
   * Allows the caller to set the denyMultiEntitlementFunctions flag using the standard Omni
   * string values.
   * 
   * @param flag
...
/**
 * @param denyMultiEntitlementFunctions the denyMultiEntitlementFunctions to set
 */
...
<<<<<<< HEAD
/**
 * @param seasonPassDemo the seasonPassDemo to set
 */
