...
<<<<<<< HEAD
   ...
   * @param props
   */
  public static void initBusinessRules(Properties props) {
  ...
  private static void applyUpgradeEntitlementRules(DTITransactionTO dtiTxn) throws DTIException {
    ...
    ArrayList<DBProductTO> dbUpgrdProdList = ProductKey.getOrderProducts(tktListTO, 
...
=======
	...
	public static void applyReservationRules(DTITransactionTO dtiTxn) throws DTIException {
		...
		// Apply any rules unique to one provider.
		if (tpiCode.compareTo(DTITransactionTO.TPI_CODE_DLR) == 0) DLRReservationRules
				.applyDLRReservationRules(dtiTxn);
		else if (tpiCode.compareTo(DTITransactionTO.TPI_CODE_WDW) == 0) WDWReservationRules
				.applyWDWReservationRules(dtiTxn);
