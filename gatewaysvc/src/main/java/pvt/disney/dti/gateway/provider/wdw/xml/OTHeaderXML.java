...
public class OTHeaderXML {
	 ...
	 */
	static void addHeaderElement(OTHeaderTO otHdrTO, Element commandStanza) throws DTIException {

		Element headerElement = commandStanza.addElement("Header");

		// ReferenceNumber
		if (otHdrTO.getReferenceNumber() == null) throw new DTIException(
				OTHeaderXML.class, DTIErrorCode.INVALID_MSG_CONTENT,
	 ...
	 */
	static OTHeaderTO getTO(Node headerNode) throws DTIException {
		...
		if (referenceNumber == null) {
			...
			throw new DTIException(OTHeaderXML.class,
		...
		if (requestNumber == null) throw new DTIException(OTHeaderXML.class,
				DTIErrorCode.TP_INTERFACE_FAILURE,
		...
		if (sessionId == null) throw new DTIException(OTHeaderXML.class,
				DTIErrorCode.TP_INTERFACE_FAILURE,
		...
		if (requestType == null) throw new DTIException(OTHeaderXML.class,
				DTIErrorCode.TP_INTERFACE_FAILURE,
		...
		if (requestSubType == null) throw new DTIException(OTHeaderXML.class,
				DTIErrorCode.TP_INTERFACE_FAILURE,
		...
		if (valueMsg == null) throw new DTIException(OTHeaderXML.class,
				DTIErrorCode.TP_INTERFACE_FAILURE,
				"Ticket provider returned XML without a Header,ValueMsg element.");

		// ValuedQty
		Node valuedQty = valueMsg.selectSingleNode("ValuedQty");
		if (valuedQty == null) throw new DTIException(OTHeaderXML.class,
				DTIErrorCode.TP_INTERFACE_FAILURE,
		...
		if (nonValuedQty == null) throw new DTIException(OTHeaderXML.class,
				DTIErrorCode.TP_INTERFACE_FAILURE,
