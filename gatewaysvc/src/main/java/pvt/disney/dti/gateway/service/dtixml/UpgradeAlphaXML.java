...
<<<<<<< HEAD
  ...
  @SuppressWarnings({ "unchecked", "rawtypes" })
	public static UpgradeAlphaResponse getJaxb(UpgradeAlphaResponseTO uaRespTO, DTIErrorTO errorTO)
      throws JAXBException {
    ...
    if (uaRespTO.getProductList() != null) {
      ...
      List<UpgradeAlphaResponse.Product> productList = uaResp.getProduct();
   ...
   */
  @SuppressWarnings({ "unchecked", "rawtypes" })
  private static void setJaxbTicketList(List<UpgradeAlphaResponse.Ticket> ticketList,
    ...
    for /* each */(TicketTO aTicketTO : /* in */ticketListTO) {
      ...
      if (aTicketTO.getVisualId() != null) {
        ...
        JAXBElement<String> visId = new JAXBElement(qName, visualId.getClass(), visualId);
  ...
  private static void setTOPaymentList(ArrayList<PaymentTO> paymentListTO,
    ...
    if (payType.getCreditCard() != null) { // THIS IS A CREDIT CARD
      ...
      UpgradeAlphaRequest.Payment.PayType.CreditCard creditCard = payType.getCreditCard();

      if (creditCard.getCCManual() != null) {

        UpgradeAlphaRequest.Payment.PayType.CreditCard.CCManual ccManual = creditCard.getCCManual();
        ...
        UpgradeAlphaRequest.Payment.PayType.CreditCard.CCSwipe ccSwipe = creditCard.getCCSwipe();
        ...
        if (ccSwipe.getExtnlDevSerial() != null) // as of 2.12
      	...
      	UpgradeAlphaRequest.Payment.PayType.CreditCard.CCWireless ccWireless = creditCard.getCCWireless();
      ...
      if (payType.getGiftCard().getGCManual() != null) {
        UpgradeAlphaRequest.Payment.PayType.GiftCard.GCManual gcManual = payType.getGiftCard()
            .getGCManual();
        ...
        UpgradeAlphaRequest.Payment.PayType.GiftCard.GCSwipe gcSwipe = payType.getGiftCard()
            .getGCSwipe();
  ...
  private static void addTicketToTOList(ArrayList<TicketTO> ticketListTO,
      ...
      if (tktId.getExternal() != null) {
        ...
        if (tktId.getTktNID() != null) {
          ...
          if (tktId.getMag() != null) {
            UpgradeAlphaRequest.Ticket.TktID.Mag tktMag = tktId.getMag();
            ...
            if (tktId.getTktDSSN() != null) {
              UpgradeAlphaRequest.Ticket.TktID.TktDSSN tktDssn = tktId.getTktDSSN();
    ...
    if (aTicket.getTktValidity() != null) {
      ...
      List<JAXBElement<XMLGregorianCalendar>> aValidityList = aTicket.getTktValidity()
        ...
        if (fieldName.getLocalPart().equalsIgnoreCase("ValidStart")) {
          if (aValidityDate.getValue() != null) {
            ...
            GregorianCalendar tempCalendar = new GregorianCalendar(
                tXCal.getEonAndYear().intValue(), (tXCal.getMonth() - 1), tXCal.getDay());
