...
public class SMLoginCommand extends AdminCommand
{
    ...
    private class SMAgent {
	    ...
	    private final ResourceBundle rb = ResourceLoader.getResourceBundle("siteminder");
        private final Properties smProps = ResourceLoader.convertResourceBundleToProperties(rb);
