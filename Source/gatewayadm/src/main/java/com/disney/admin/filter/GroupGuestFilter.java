 ...
 */
public class GroupGuestFilter implements ServletFilterIF
{
    //~ Constructors -----------------------------------------------------------


    /**
     * Constructor for GroupGuestFilter.
     */
    public GroupGuestFilter()
    {
        super();
    }
    ...
    ) throws IOException, ServletException
    {
        ...
        if (
            ...
            || !(
                !(userGroup.equals("GUEST")) || !(userGroup.equals("DEFAULT"))
