...
/**
 * This class represents the request parameters of a Reservation response.
 * 
 * @author lewit019
 * 
 */
public class ReservationResponseTO extends CommandBodyTO implements Serializable {
