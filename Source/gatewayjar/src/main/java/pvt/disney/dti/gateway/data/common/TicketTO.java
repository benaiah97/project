...
public class TicketTO implements Serializable, Cloneable {
   ...
   /**
    * The UpgradeEligibilityStatusType for providing the upgrade eligibility
    * information.
    */
   ...
   /**
    * The PayPlanEligibilityStatusType for providing the pay plan eligibilty
    * Status.
    */
   ...
   /** The from product code. */
   private String fromDlrPLU; // 2.17.3
   ...
   private UpgradeEligibilityStatusType upgradeEligibilityStatus = UpgradeEligibilityStatusType.ELIGIBLE; // RASTA006
                                                                                                          // 2.17.3
   ...
   private PayPlanEligibilityStatusType payPlanEligibilityStatus = PayPlanEligibilityStatusType.NO;
   ...
   /**
    * Used to represent the pair of repeating status items and status values for
    * tickets.
    * 
    * @author lewit019
    */
    ...
    * entitlement account. This is an account and the number of these tickets to
    * associate with it.
    * 
    * @author SHIEC014
    * 
   ...
   /**
    * @return the fromDlrPLU
    */
   public String getFromDlrPLU() {
      return fromDlrPLU;
   }
   ...
   /**
    * @param payPlanEligibilityStatus
    *           the payPlanEligibilityStatus to set
    */
   ...
   /**
    * @param fromDlrPLU the fromDlrPLU to set
    */
   public void setFromDlrPLU(String fromDlrPLU) {
      this.fromDlrPLU = fromDlrPLU;
   }
   ...
   public TicketTO clone() throws CloneNotSupportedException {
      ...
      if (this.fromDlrPLU != null) {
         aClone.fromDlrPLU = this.fromDlrPLU;
      }
