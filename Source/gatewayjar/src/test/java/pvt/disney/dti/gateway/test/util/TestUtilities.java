...
public class TestUtilities {
  ...
  public static String getTagData(String xml, String tagName) {
    ...
    startTag += tagName.length() + 2; // Move pointer to start of error value.
  ...
  /**
   */
  public static ArrayList<String> getRecurringTagData(String xml, String tagName) {
    ...
    while (startTag != -1) {
      ...
      startTag += tagName.length() + 2; // Move pointer to start of tag value.
      String tagString = searchString.substring(startTag, endTag);
      recurringTags.add(tagString);

      searchString = searchString.substring(endTag + tagName.length() + 3);
  ...
  /**
   * A simple routine to locate the value of a unique XML tag in an XML string.
   * returns false if the tag isn't present; true if it is present.
   * 
   * @param xml
   *          All of the XML to be searched as one string.
   * @param tagName
  ...
  /**
   * Helper method.
   * Creates a dom4j document from a file containing xml and returns it to the
   * caller.
 * @param aFile
 * @return
 * @throws DocumentException
 */
public static org.dom4j.Document getDom4jDocFromFile(File aFile) throws DocumentException{
  ...
  /**
   * Helper Method.
   * Creates a dom4j document from the file represented by the passed in file 
   * name and returns it to the caller.
 * @param aFileName
 * @return
 * @throws IOException
 * @throws DocumentException
 */
public static org.dom4j.Document getDom4jDocFromFile(String aFileName) throws IOException, DocumentException {
