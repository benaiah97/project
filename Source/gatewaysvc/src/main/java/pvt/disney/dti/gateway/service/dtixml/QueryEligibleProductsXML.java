...
public class QueryEligibleProductsXML {
	...
	public static QueryEligibleProductsRequestTo getTO(
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	  public static QueryEligibleProductsResponse getJaxb(QueryEligibilityProductsResponseTo qryResRespTO, DTIErrorTO errorTO)
	      throws JAXBException{
	   ...
	   // Ticket Demographics
	      ...
	      if(aTicketTO.getProdCode()!=null && aTicketTO.getProdPrice()!=null){
	    	  ...
	    	  eligibleproduct.setProdPrice(String.valueOf(aTicketTO.getProdPrice()));
	    	  eligibleproduct.setProdTax(aTicketTO.getTktTax());
	    	  eligibleproduct.setUpgrdPrice(String.valueOf(aTicketTO.getUpgrdPrice()));
