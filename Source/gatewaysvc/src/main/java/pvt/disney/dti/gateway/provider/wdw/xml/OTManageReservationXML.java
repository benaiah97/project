 ...
 * @author lewit019
 */
public class OTManageReservationXML {
   ...
   */
  static void addTxnBodyElement(OTManageReservationTO otMngResTO,
    ...
    OTCommandXML.addWorkRules(mngResStanza, tagList);
    ...
    // PaymentInfo
    OTCommandXML.addPaymentInfoStanza(mngResStanza,
    ...
    if (otMngResTO.getAssociationInfo() != null) {
      ...
      OTAssociationInfoTO otAsnInfoTO = otMngResTO.getAssociationInfo();
      ...
      if (otAsnInfoTO.getDemographicData().size() > 0) {
        ...
        ArrayList<OTFieldTO> aFieldList = otAsnInfoTO
            .getDemographicData();

        OTCommonXML.addOTDemoAsFieldId(demoDataStanza, aFieldList);
    ...
    if (otMngResTO.getExternalTransactionID() != null) {
      ...
      OTExternalTransactionIDTO otExtTxnIdTO = otMngResTO.getExternalTransactionID();
  ...
  private static void addEntitlementAccountStanza(
      OTManageReservationTO otMngResTO, Element mngResStanza) {
    // EntitlementAccount
    if (otMngResTO.getEntitlementAccountCreationTypology() != null) {
      ...
      for (OTAccountDataTO account : otMngResTO.getAccountsData()) {
        ...
        if (account.getDemoData() != null) {
          Element demoDataStanza = accountStanza
              .addElement("DemographicData");
          ArrayList<OTFieldTO> aFieldList = account.getDemoData()
              .getDemoDataList();
        ...
        if (account.getMediaDataList() != null) {
          ...
          for (OTMediaDataTO mediaItem : aMediaList) {
  ...
  private static void addClientDataStanza(Element txnStanza,
    ...
    if ((cliDataTO.getDemographicData() != null) && (cliDataTO
      ...
      ArrayList<OTFieldTO> aFieldList = cliDataTO.getDemographicData();

      OTCommonXML.addOTDemoAsFieldId(demoStanza, aFieldList);
  ...
  static OTManageReservationTO getTO(Node manageResNode) throws DTIException {
    ...
    else otMngResTO.setError(OTCommandXML.setOTErrorTO(errorNode));
    ...
    if (tranDssnNode != null) otMngResTO.setTransactionDSSN(OTCommandXML
   ...
   *             for any parsing errors or missing required fields.
   */
  private static void setOTProductTOList(ArrayList<OTProductTO> otPdtList,
    ...
    for /* each */(Node aNode : /* in */pdtList) {
      ...
      OTProductTO otPdtTO = new OTProductTO();
   ...
   *             for any parsing errors or missing required fields.
   */
  private static OTReservationDataTO setOTReservationDataTO(Node resDataNode) throws DTIException {

    OTReservationDataTO otResData = new OTReservationDataTO();
   ...
   */
  private static OTClientDataTO setOTClientDataTO(Node cliDataNode) throws DTIException {
   ...
   */
  @SuppressWarnings("unchecked")
  private static void setDemoFieldList(ArrayList<OTFieldTO> otDemoFieldList,
    ...
    for /* each */(Node aNode : /* in */fieldNodeList) {
      ...
      OTFieldTO otField = new OTFieldTO(fieldId, fieldType, fieldValue);
