...
public class DLRUpgradeEntitlementRules implements TransformConstants{
	  ...
	  static String transformRequest(DTITransactionTO dtiTxn) throws DTIException {
	    ...
	    UpgradeEntitlementRequestTO upgradeRequest = (UpgradeEntitlementRequestTO) dtiTxn
	    ...
	    if (upgradeRequest.isInstallmentRequest()) {
	      ...
	      if (upgradeRequest.getInstallmentDownpayment() != null) {
	        String downPaymentAmount = upgradeRequest.getInstallmentDownpayment()
	            .toString();
	    ...
	    BigDecimal orderTotal = setProductOrderLines(upgradeRequest, orderTO,
	    ...
	    boolean missingCvv = setPaymentOrderLines(upgradeRequest, orderTO,
	  ...
	  private static BigDecimal setProductOrderLines(
			  UpgradeEntitlementRequestTO upgradeRequest, GWOrderTO orderTO,
	    ...
	    while (iter.hasNext()) {
	      ...
	      if ((dtiProduct.getDaySubclass().equalsIgnoreCase(GW_RENEW)) || (dtiProduct
	        ...
	        gwLineItemTO
	            .setDetailType(TransformConstants.GW_ORDERS_UPGRADE_ORDER_LINE_ITEM);
	      }
	      else {
	    	  gwLineItemTO
	  ...
	  private static boolean setPaymentOrderLines(
	    ...
	    Iterator<PaymentTO> paymentIter = upgradeRequest.getPaymentList()
	        .iterator();
