 ...
 * @since 2.16.3
 */
public class HkdOTCommandTO implements Serializable {
  ...
  private HkdOTHeaderTO headerTO;

  /** The Omni Ticket Manage Reservation Transfer Object. */
  private HkdOTManageReservationTO manageReservationTO;
   ...
   */
  public HkdOTCommandTO(OTTransactionType txnTypeIn) {
    txnType = txnTypeIn;
  }
   ...
   * @return the headerTO
   */
  public HkdOTHeaderTO getHeaderTO() {
    return headerTO;
  }
   ...
   */
  public HkdOTManageReservationTO getManageReservationTO() {
   ...
   *            the headerTO to set
   */
  public void setHeaderTO(HkdOTHeaderTO headerTO) {
   ...
   */
  public void setManageReservationTO(HkdOTManageReservationTO manageReservationTO) {
   ...
   */
  public HkdOTErrorTO getErrorTO() {

    HkdOTErrorTO otErrorTO = null;
