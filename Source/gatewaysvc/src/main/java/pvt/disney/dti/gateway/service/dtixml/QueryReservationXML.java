...
public abstract class QueryReservationXML {
   ...
   */
  public static QueryReservationRequestTO getTO(QueryReservationRequest queryResReq) throws JAXBException {

    // Create the query reservation request transfer object and set request
    // type.
  ...
  public static QueryReservationResponse getJaxb(QueryReservationResponseTO qryResRespTO, DTIErrorTO errorTO)
      throws JAXBException {
    ...
    if (qryResRespTO.getTicketList() != null) {
      List<QueryReservationResponse.Ticket> ticketList = resResp.getTicket();
    ...
    if (qryResRespTO.getProductList() != null) {
      ...
      List<QueryReservationResponse.Product> productList = resResp.getProduct();
    ...
    if (qryResRespTO.getPaymentList() != null) {
      List<QueryReservationResponse.Payment> paymentList = resResp.getPayment();
   ...
   *           for any JAXB parsing issue.
   */
  private static void setJaxbPaymentList(List<QueryReservationResponse.Payment> paymentList,
    ...
    for /* each */(PaymentTO aPaymentTO : /* in */paymentListTO) {
      ...
      if (aPaymentTO.getCreditCard() != null) {
        ...
        if (aPaymentTO.getPayAmount() != null) {
          aPayment.setPayAmount(aPaymentTO.getPayAmount().doubleValue());
        }
   ...
   */
  @SuppressWarnings({ "unchecked", "rawtypes" })
  private static void setJaxbTicketList(List<QueryReservationResponse.Ticket> ticketList,
    ...
    for /* each */(TicketTO aTicketTO : /* in */ticketListTO) {
      ...
      if (aTicketTO.getProdCode() != null) {
        ...
        JAXBElement<String> tktProdCodeElement = new JAXBElement(qName, aTicketTO.getProdCode().getClass(),
      ...
      if (aTicketTO.getAccountId() != null) {
        ...
        JAXBElement<String> accountId = new JAXBElement(qName, tktAccountId.getClass(), tktAccountId);
