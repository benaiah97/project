 ...
 * @since 2.16.3
 */
public class HkdOTTicketInfoTO implements Serializable {
  ...
  private ArrayList<HkdOTUsagesTO> usagesList = new ArrayList<HkdOTUsagesTO>();

  /** The full ticket identify information. */
  private HkdOTTicketTO ticket;
  ...
  private HkdOTDemographicData seasonPassDemo;
   ...
   */
  public ArrayList<HkdOTUsagesTO> getUsagesList() {
    return usagesList;
  }
   ...
   */
  public void setUsagesList(ArrayList<HkdOTUsagesTO> usagesList) {
  ...
  public void setValidityEndDate(String validityEndDate) throws ParseException {
    ...
    this.validityEndDate = HkdOTCommandTO.convertOmniYYDate(validityEndDate);
  ...
  public void setValidityStartDate(String validityStartDate) throws ParseException {
    ...
    this.validityStartDate = HkdOTCommandTO
   ...
   * @return the ticket
   */
  public HkdOTTicketTO getTicket() {
    return ticket;
  }
   ...
   *            the ticket to set.
   */
  public void setTicket(HkdOTTicketTO ticket) {
    this.ticket = ticket;
  }
   ...
   */
  public HkdOTDemographicData getSeasonPassDemo() {
   ...
   */
  public void setSeasonPassDemo(HkdOTDemographicData seasonPassDemo) {
