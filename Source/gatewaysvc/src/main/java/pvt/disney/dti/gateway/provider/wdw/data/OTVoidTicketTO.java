...
import pvt.disney.dti.gateway.provider.wdw.data.common.OTTicketInfoVoidTO;
...
/**
 * This class is a transfer object which represents the Omni Ticket void ticket.
 * 
 * @author lewit019
 */
public class OTVoidTicketTO implements Serializable {
	...
	/** The v ticket. */
	private ArrayList<OTVTicketTO> vTicketList = new ArrayList<OTVTicketTO>();
	...
	/** The ticket info void. */
	private ArrayList<OTTicketInfoVoidTO> ticketInfoVoidList = new ArrayList<OTTicketInfoVoidTO>();
	...
	/**
	 * Gets the ticket info void.
	 * 
	 * @return the ticketInfoVoidList
	 */
	public ArrayList<OTTicketInfoVoidTO> getTicketInfoVoidList() {
		return ticketInfoVoidList;
	}
	 ...
	 * Gets the v ticket.
	 * 
	 * @return the vTicketList
	 */
	public ArrayList<OTVTicketTO> getVTicketList() {
		return vTicketList;
	}
	...
	/**
	 * Sets the ticket info void.
	 * 
	 * @param ticketInfoVoidList
	 *            the ticketInfoVoidList to set
	 */
	public void setTicketInfoVoidList(
			ArrayList<OTTicketInfoVoidTO> ticketInfoVoid) {
		this.ticketInfoVoidList = ticketInfoVoid;
	}
	 ...
	 * 
	 * @param ticket
	 *            the vTicketList to set
	 */
	public void setVTicketList(ArrayList<OTVTicketTO> ticket) {
		vTicketList = ticket;
	}
