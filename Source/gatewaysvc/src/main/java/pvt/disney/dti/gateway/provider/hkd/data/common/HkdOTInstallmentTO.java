 ...
 * @since 2.16.3
 */
public class HkdOTInstallmentTO implements Serializable {
  
	private static final long serialVersionUID = 1L;
	
	public static final int CONTRACTALPHAPURCHASE = 3;
	
	public static final int CONTRACTALPHARENEWAL = 4;
	...
	/** Contract Alpha Code (As of 2.16.2, JTL) */
	private int contractAlphaCode;
  ...
  /**
   * @return the contractAlphaCode
   */
  public int getContractAlphaCode() {
    return contractAlphaCode;
  }

  /**
   * @param contractAlphaCode the contractAlphaCode to set
   */
  public void setContractAlphaCode(int contractAlphaCode) {
    this.contractAlphaCode = contractAlphaCode;
  }
