...
public class TransformRulesTestCase {
	...
	public final void testCreateRespCmdHdr() {
		...
		assertFalse("Invalid value found in CmdItem: " + respHeader.getCmdItem(),
				respHeader.getCmdItem().compareTo(CMDITEM) != 0);

		// CmdDuration
		assertFalse("Invalid value found in CmdDuration: "
				+ respHeader.getCmdDuration(),
				respHeader.getCmdDuration().compareTo(ZERO_DURATION) != 0);
