 ...
 */
public class GroupDefaultFilter implements ServletFilterIF
{
    //~ Constructors -----------------------------------------------------------


    /**
     * Constructor for GroupDefaultFilter.
     */
    public GroupDefaultFilter()
    {
        super();
    }
    ...
    ) throws IOException, ServletException
    {
        ...
        if (
            ...
            || !(
                !(userGroup.equals("DEFAULT")) || !(userGroup.equals("USER"))
