 ...
 * @author RRA3
 */
public class SiteMinderDefaultFilter extends SiteMinderUserFilter {
    //~ Constructors -----------------------------------------------------------


    /**
     * Constructor for SiteMinderDefaultFilter.
     */
    public SiteMinderDefaultFilter() {
        super();
    }
     ...
     * user is in the ADMIN, SUPERUSER, USER, or DEFAULT group
     *
    ...
    public void doFilter(HttpServletRequest request,
        ...
        if (((uGroup != null)
            ...
            || uGroup.equals(USER))) || uGroup.equals(DEFAULT)) {
